...
class Example(Base):
    ...
    def initialize(self):
        ...
        point_light1 = PointLight(color=[0.9, 0.9, 0], position=[1.5*SUN_SIZE, 0, 1.5*SUN_SIZE], attenuation=[SUN_LIGHT,0,SUN_LIGHT])
        self.scene.add(point_light1)
        point_light2 = PointLight(color=[0.9, 0.9, 0], position=[-1.5*SUN_SIZE, 0, 1.5*SUN_SIZE], attenuation=[SUN_LIGHT,0,SUN_LIGHT])
        self.scene.add(point_light2)
        point_light3 = PointLight(color=[0.9, 0.9, 0], position=[-1.5*SUN_SIZE, 0, -1.5*SUN_SIZE], attenuation=[SUN_LIGHT,0,SUN_LIGHT])
        self.scene.add(point_light3)
        point_light4 = PointLight(color=[0.9, 0.9, 0], position=[1.5*SUN_SIZE, 0, -1.5*SUN_SIZE], attenuation=[SUN_LIGHT,0,SUN_LIGHT])
        self.scene.add(point_light4)
        point_light5 = PointLight(color=[0.9, 0.9, 0], position=[0, 2*SUN_SIZE,0], attenuation=[SUN_LIGHT,0,SUN_LIGHT])
        self.scene.add(point_light5)
        point_light6 = PointLight(color=[0.9, 0.9, 0], position=[0, -2*SUN_SIZE,0], attenuation=[SUN_LIGHT,0,SUN_LIGHT])
        ...
        #Sun Object
        sun = SphereGeometry(radius=SUN_SIZE)
        ...
        self.earth.set_position([5*SUN_SIZE, 0, 0])
    ...
    def update(self):
        ...
        self.earth.rotate_y(0.01337/self.SUN_SIZE)
